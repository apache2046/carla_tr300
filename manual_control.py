...
class KeyboardControl(object):
    ...
    def _parse_vehicle_tr300(self):
        ...
        for data in g:
            ...
            elif data.type == 1: #buttons
                if data.code == 299 and data.value == 1:
...
class HUD(object):
    def __init__(self, width, height):
        ...
        self.way_point_file = open("/tmp/waypoint.txt", "w")
        self.way_point_clk = 0
    ...
    def __init__(self, parent_actor, hud, gamma_correction):
        ...
        if not self._parent.type_id.startswith("walker.pedestrian"):
            self._camera_transforms = [
                (carla.Transform(carla.Location(x=0.15*bound_x, y=-0.2*bound_y, z=0.9*bound_z), carla.Rotation(pitch=0, yaw=6)), Attachment.Rigid),
